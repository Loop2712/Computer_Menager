                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Room Id</th><th>Status</th><th>Study Desk</th><th>Location</th><th>Note</th><th>Proto</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($room as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->Room_id }}</td><td>{{ $item->status }}</td><td>{{ $item->study_desk }}</td><td>{{ $item->location }}</td><td>{{ $item->note }}</td><td>{{ $item->proto }}</td>
                                        <td>
